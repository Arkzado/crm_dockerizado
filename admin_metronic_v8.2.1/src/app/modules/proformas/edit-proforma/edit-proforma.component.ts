...
export class EditProformaComponent {
  ...
  ALL_MUNICIPIOS:any = UBIGEO_MUNICIPIO;
  ...
  ngOnInit(): void {
    ...
    this.proformaService.showProforma(this.PROFORMA_ID).subscribe((resp:any) => {
      ...
      // --- INICIO CARGA DE DATOS UBIGEO COLOMBIA ---
      this.ubigeo_departamento = this.PROFORMA_SELECTED.proforma_deliverie.ubigeo_departamento;
      this.ubigeo_municipio = this.PROFORMA_SELECTED.proforma_deliverie.ubigeo_municipio;
      this.departamento = this.PROFORMA_SELECTED.proforma_deliverie.departamento;
      this.municipio = this.PROFORMA_SELECTED.proforma_deliverie.municipio;

      // Populamos la lista de municipios para el dropdown
      if (this.ubigeo_departamento) {
        this.MUNICIPIOS_SELECTEDS = this.ALL_MUNICIPIOS.filter((muni:any) => muni.department_id == this.ubigeo_departamento);
      }
      // --- FIN CARGA DE DATOS UBIGEO COLOMBIA ---
      ...
      this.description = this.PROFORMA_SELECTED.description;
  ...
  changeDepartamento($event:any){
    ...
    let DEPARTAMENTO_SELECTED = this.DEPARTAMENTOS.find((depto:any) => depto.id == DEPARTAMENTO_ID);
    ...
    this.MUNICIPIOS_SELECTEDS = this.ALL_MUNICIPIOS.filter((muni:any) => muni.department_id == DEPARTAMENTO_ID);
  ...
  changeMunicipio($event:any){
    ...
    let MUNICIPIO_SELECTED = this.MUNICIPIOS_SELECTEDS.find((muni:any) => muni.id == MUNICIPIO_ID);
  ...
  save(){
    ...
    if(this.ubigeo_departamento){
      formData.append("ubigeo_departamento",this.ubigeo_departamento);
      formData.append("departamento",this.departamento);
    }else{
      formData.append("ubigeo_departamento",'');
      formData.append("departamento",'');
    }
    if(this.ubigeo_municipio){
      formData.append("ubigeo_municipio",this.ubigeo_municipio);
      formData.append("municipio",this.municipio);
    }else{
      formData.append("ubigeo_municipio",'');
