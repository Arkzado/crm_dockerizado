...
// IMPORTACIONES DE UBIGEO COLOMBIA
...
export class CreateProformaComponent {
  ...
  // --- INICIO DE VARIABLES DE UBIGEO COLOMBIA ---
  ...
  departamento:string = '';
  municipio:string = '';
  // --- FIN DE VARIABLES DE UBIGEO COLOMBIA ---
  ...
  changeDepartamento($event:any){
    let DEPARTAMENTO_ID = $event.target.value; // ej: "05"
  ...
  changeMunicipio($event:any){
    let MUNICIPIO_ID = $event.target.value; // ej: "05001"
