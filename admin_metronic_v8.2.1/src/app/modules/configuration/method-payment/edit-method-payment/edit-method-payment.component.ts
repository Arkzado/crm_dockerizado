...
export class EditMethodPaymentComponent {
  ...
  get filteredMethodPayments() {
    // Filtra para que no aparezca el método de pago actual como opción
    return this.METHOD_PAYMENTS.filter((mp: any) => mp.id !== this.METHOD_PAYMENT_SELECTED.id);
  }
