    ...
    <tbody>
        @foreach ($proforma_details as $key => $proforma_detail)
            <tr>
                ...
                <td>{{ $proforma_detail->price_unit }} COP</td>
                <td>{{ $proforma_detail->discount }} COP</td>
                <td>{{ $proforma_detail->subtotal }} COP</td>
                <td>{{ $proforma_detail->impuesto }} COP</td>
                <td>{{ $proforma_detail->quantity }} </td>
                <td>{{ $proforma_detail->total }} COP</td>
