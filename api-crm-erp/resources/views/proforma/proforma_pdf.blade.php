    ...
    <tbody>
        @foreach ($proforma->details as $detail)
            <tr>
                ...
                <td class="right">{{ $detail->subtotal + $detail->impuesto }} COP</td>
                <td class="bold">{{ $detail->total }} COP</td>
            </tr>
        @endforeach
    </tbody>
  </table>
    ...
    <tbody>
      <tr>
        ...
        <td class="payment-info">
            ...
            <div>
              ADELANTADO: <strong>{{ $proforma->paid_out }} COP</strong>
            </div>
            <div>
              SALDO: <strong>{{ $proforma->debt }} COP</strong>
            </div>
        </td>
    </tbody>
  </table>
